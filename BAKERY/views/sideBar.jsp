	...
	<div class="wrapper">
		...
		<div class="main-header" data-background-color="purple">
			...
			<div class="logo-header">
				...
				<a href="/BAKERY" class="logo" style="font-weight: bolder; letter-spacing : 2px">
					BAKERY
				</a>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="Ingredient?action=liste">
											<span class="sub-item">Liste Ingredient</span>
										</a>
									</li>
									<li>
										<a href="Product?action=liste">
											<span class="sub-item">Liste Product</span>
										</a>
									</li>
                                    <li>
										<a href="Production?action=listAll">
											<span class="sub-item">Liste Production</span>
										</a>
									</li>
									<li>
										<a href="Sale?action=listAll">
											<span class="sub-item">Liste Sale</span>
										</a>
									</li>
									<li>
										<a href="Recommended?action=listAll">
											<span class="sub-item">Liste Recommended</span>
										</a>
									</li>
									<li>
										<a href="Commission?action=listAll">
											<span class="sub-item">Liste Commission</span>
										</a>
									</li>
									<li>
